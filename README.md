...
## _This project is no longer maintained. Please visit [vulgar](https://github.com/datatypevoid/vulgar) to follow the new version, and check out our new command line tool for generating and managing cutting-edge MEAN stack apps at [vulgar-cli](https://github.com/datatypevoid/vulgar-cli)_
